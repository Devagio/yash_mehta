        ...
        mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                ...
                className='flex flex-col w-full md:w-1/2' method='POST'>
                    ...
                    Name...' className='p-2 bg-transparent border-2 
                    rounded-md text-white focus:outline-none' />
                    <input type='text' name='email' placeholder='Enter your 
                    Email-ID...' className='p-2 bg-transparent border-2 
                    rounded-md text-white my-4 focus:outline-none' />
                    <textarea name='message' placeholder='Enter your 
                    Message...' rows='6' className='p-2 bg-transparent 
